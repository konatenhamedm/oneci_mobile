...
class _HomeServiceIdentiteState extends State<HomeServiceIdentite> {
  final List<PlaceInfo> items = [
    PlaceInfo(' Acheter un timbre CNI', '437532.png', 'achat'),
    PlaceInfo("Suivi de la status de la Carte Nationale d'Identité",
        '76828.png', 'suivi'),
    PlaceInfo("Demande de carte de resistance", '10415.png', 'demande'),
  ];
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                      onTap: () {
                        ...
                        } else if (items[index].type == 'suivi') {
                      ...
                      child: CardWidget(
                        items: items,
                        widget: widget,
                        imagePath: 'assets/${items[index].image}',
                        titre: ' ${items[index].titre}',
                      ));
                },
              ),
            ),
...
class CardWidget extends StatelessWidget {
  ...
  final List<PlaceInfo> items;
  final HomeServiceIdentite widget;
