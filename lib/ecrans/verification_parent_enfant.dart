...
import 'package:oneci/ecrans/face_recognition_parent_screen.dart';
...
class VerificationParentEnfant extends StatefulWidget {
  final String type,nniParent,nniEnfant;
  const VerificationParentEnfant({super.key,required this.type,required this.nniEnfant,required this.nniParent});

  @override
  State<VerificationParentEnfant> createState() => _VerificationParentEnfantState();
}

class _VerificationParentEnfantState extends State<VerificationParentEnfant> {
  ...
  Widget build(BuildContext context) {
    Future.delayed(Duration.zero, () async {
      await personneController.fetchVerification(nni: widget.nniEnfant);
              ...
              return ListView(
                ...
                children: <Widget>[
                  ...
                  FormHelper.saveButtonNew('Passer à réconnaissance faciale', () async{
                    ...
                    Get.to(FaceRecognitionParentScreen(camera: firstCamera,nni: widget.nniEnfant,nn_parent: widget.nniParent,type: widget.type,));
                  },50),
