...
class FaceRecognitionParentScreen extends StatefulWidget {
  final CameraDescription camera;
  final String nni;
  final String nn_parent;
  final String type;

  const FaceRecognitionParentScreen({Key? key, required this.camera, required this.nni,required this.nn_parent, required this.type}) : super(key: key);

  @override
  _FaceRecognitionParentScreenState createState() => _FaceRecognitionParentScreenState();
}

class _FaceRecognitionParentScreenState extends State<FaceRecognitionParentScreen> {
